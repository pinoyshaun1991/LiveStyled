...
You are not excepted to add any additional functionality but you need to work in a test driven manner, it is required to submit the tests with your result.
